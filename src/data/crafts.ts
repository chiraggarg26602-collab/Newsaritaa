...
export const CRAFT_DETAILS: Record<string, CraftDetail> = {
  Bagru: {
    ...
    heroImage: '/craft/woodblock-carving.jpg',
    processSteps: [
      {
        stepNumber: 1,
        ...
        imageUrl: '/craft/woodblock-carving.jpg'
      },
      {
        stepNumber: 2,
        ...
        imageUrl: '/craft/fabric-treatment.jpg'
      },
      {
        stepNumber: 3,
        ...
        imageUrl: '/craft/hand-stamping.jpg'
      },
      {
        stepNumber: 4,
  ...
  Sanganeri: {
    ...
    heroImage: '/craft/hand-stamping.jpg',
    processSteps: [
      {
        stepNumber: 1,
  ...
  Ajrakh: {
    ...
    heroImage: '/craft/fabric-treatment.jpg',
    processSteps: [
      {
        stepNumber: 1,
        title: 'Woodblock Carving',
